...
export const COPY = {
  ...
  // Verdict (AnswerBlock): the first matching line, then the plan line. {period} is a phrase below.
  'overview.verdict.revenueOff': "Income is not visible: Stripe is not connected or didn't answer. Costs {period}: {cost}.",
  'overview.verdict.plus': 'We are {result} in the plus {period}: income {income}, costs {cost}.',
  'overview.verdict.noIncomeAll': 'We are {cost} in the minus {period}: there were no payments. All the costs went to {freeWho}.',
  'overview.verdict.noIncome': 'We are {cost} in the minus {period}: there were no payments. {freeShare} of the costs went to {freeWho}.',
  'overview.verdict.minus': 'We are {loss} in the minus {period}: income of {income} did not cover costs of {cost}.',
  'overview.verdict.plan': 'By the plan ({scenario}): with {s0} doctors ≈ {r0} a month, with {s1} ≈ {r1}.',
  ...
  'overview.period.lastDays': 'over the last {n} days',
  'overview.period.month': 'in {month}',
  'overview.period.monthSoFar': 'in {month} so far',
  'overview.period.year': 'in {year}',
  'overview.period.yearSoFar': 'in {year} so far',
  'overview.period.allTime': 'since {date}',
  'overview.period.range': 'over {range}',
  ...
  'overview.payers.sub': '{share} of costs go to them',
  'overview.health.ok': 'Yes',
  'overview.health.slow': 'Some delays',
  'overview.health.bad': 'There are failures',
...
export const DEFS = {
  ...
  'overview.health': {
    short: '“Yes” — forms come fast and without failures; “Some delays” — some forms took longer than 15 s; “There are failures” — doctors saw errors. Counts all traffic.',
    long: '“Yes”: under 2% of forms took longer than 15 s and the backup model answered under 1% of the time. “There are failures”: 3 or more service errors, or 5% of forms over 15 s. A form is usually ready in 4–7 s; over 25 s almost always means the main model did not make it in time and the backup model answered. The “Without my and test accounts” switch does not apply here: your own account is real load too.',
  },
  'overview.scale': {
